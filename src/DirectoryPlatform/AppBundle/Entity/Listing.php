...
class Listing
{
    ...
    const TYPE_FOUND = 'FOUND_PRODUCT';

    const TYPE_LOST = 'LOST_PRODUCT';
	...
	/**
     * @ORM\Column(name="product_type", type="string", nullable=false, length=50)
     */
    private $productType = self::TYPE_FOUND;
