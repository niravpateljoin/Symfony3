...
namespace DirectoryPlatform\AppBundle\DependencyInjection;
	...
	public function getConfigTreeBuilder()
	{
		...
		$rootNode
			->children()
                ...
                ->scalarNode('map_styles')->defaultNull()->end()

                ->arrayNode('payments')->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('pay_for_featured')->addDefaultsIfNotSet()
                            ->children()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('pay_for_publish')->addDefaultsIfNotSet()
                            ->children()
                ...
                ->arrayNode('gateways')->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('wire')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('enabled')->defaultValue(false)->end()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('paypal')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('enabled')->defaultValue(false)->end()
                            ...
                            ->end()
                        ->end()
                        ->arrayNode('stripe')->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('enabled')->defaultValue(false)->end()
                                ->scalarNode('id')->defaultValue('stripe')->end()
                                ->scalarNode('name')->defaultValue('Credit/Debit')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()

			->arrayNode('invoicing')->addDefaultsIfNotSet()
			    ->children()
